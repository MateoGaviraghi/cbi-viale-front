...
export function GonzaloPhoto() {
  ...
  return (
    <div className="relative aspect-[4/5] w-full bg-beige">
      {!failed && (
        <Image
          src="/equipo/gonzalo-alvarez.jpg"
          alt="Gonzalo Alvarez — Bioquímico, CBI Viale"
          fill
      ...
      {failed && (
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 select-none pointer-events-none">
          <span className="font-serif text-6xl text-gold-700/30 leading-none">GA</span>
